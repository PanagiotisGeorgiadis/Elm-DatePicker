module DateTime.DateTime exposing
    ...
    , getNextMonth, getPreviousMonth, getDateRange, getDatesInMonth
...
@docs getNextMonth, getPreviousMonth, getDateRange, getDatesInMonth


# Utilities

@docs getDatesInMonth, getDateRange
